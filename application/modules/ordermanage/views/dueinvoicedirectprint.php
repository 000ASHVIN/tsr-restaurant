  ...
  <div class="invoice-card">
    ...
    <div class="invoice-footer mb-15">
      ...
      <div class="row-data">
        ...
        <h5 class="my-5"> <?php echo ($customepaid * 2300)." ". $currencyFc->curr_icon;?></h5>
    </div>
    </div>
    <div class="invoice_address">
      <div class="row-data">
      ...
      <div class="row-data">
          <div class="item-info">
              <h5 class="item-title mt-10 mb-15">&nbsp;</h5>
          </div>
      </div>
      <div class="row-data">
          <div class="item-info">
              <h5 class="item-title mt-10 mb-15"><?php echo display('customer_signature');?>: <span style="width: 400px;height: 20px;border-bottom: 1px solid #000;"></span>
          </div>
      </div>
      <div class="row-data">
          <div class="item-info">
      ...
      <div class="middle-data">
                  <div class="text-center">
                    <h5 class="item-title" style="font-size:18px; font-weight:bold;"><?php echo "Payment Status";?>: 
                    <?php 
                    echo 'Paid';
                    // if($billinfo->bill_status == 1){
                    //     echo 'Paid';
