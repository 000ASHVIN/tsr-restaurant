        ...
        <div class="login-content login-content_bg">
        	<div class="">
                ...
                <div class="form-group">
                    <label for="email"><?php echo display('firstname') ?></label>
                    <input type="text" placeholder="<?php echo display('firstname') ?>" name="email" id="email" class="form-control fs-15px" autocomplete="off"> 
                </div>
                <div class="form-group">
